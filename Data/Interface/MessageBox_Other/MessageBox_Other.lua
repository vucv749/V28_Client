...
function MessageBox_Other_OnEvent(event)
	...
	if ( event == "SHOW_TEAM_YES_NO" ) then
		...
		MessageBox_Other_Text:SetText(arg0.." m¶i các hÕ vào ğµi");
		this:Show();
	...
	elseif ( event == "TEAM_MEMBER_INVITE" ) then
		...
		MessageBox_Other_Text:SetText(arg0.."M¶i" .. arg1 .. "vào ğµi, ğ°ng ı không?");
		this:Show();
		MessageBox_Other_Show_single_Info( 0 );
		g_InitiativeClose = 0;
	...
	elseif ( event == "TEAM_APPLY" ) then
		...
		MessageBox_Other_Text:SetText(arg0.." xin vào ğµi, ğ°ng ı?");
		this:Show();
		MessageBox_Other_Show_single_Info( 0 );
		g_InitiativeClose = 0;
	...
	elseif ( event == "TEAM_FOLLOW_INVITE" ) then
		...
		AxTrace( 0, 0, "Ğµi trß·ng m¶i vào chª ğµ ği theo ğµi" );
		MessageBox_Other_Text:SetText(arg0.." mu¯n các hÕ theo ğµi, ğ°ng ı không?");
		this:Show();
		MessageBox_Other_Show_single_Info( 0 );
		g_InitiativeClose = 0;
	...
	elseif( event == "OPEN_CALLOF_PLAYER" )   then 
		...
		MessageBox_Other_Text:SetText(szName .. " dçn d¡t các hÕ, ğ°ng ı không?");
		this:Show();
		MessageBox_Other_Show_single_Info( 0 );
		g_InitiativeClose = 0;
	elseif( event == "RECIVE_RIDE" ) then
		...
		local szName = arg0;
		MessageBox_Other_Text:SetText(szName .. "M¶i cßŞi chung");	
		this:Show();
		MessageBox_Other_Show_single_Info( 0 );
		g_InitiativeClose = 0;
	end
