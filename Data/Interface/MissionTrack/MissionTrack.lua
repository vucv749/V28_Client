...
local g_MissionTrack_AutoMissionList = {
	891274, 891275, 891276, 891277, 891278, 891279, --修炼任务
}
...
function MissionTrack_CheckScriptId_CanAutoRun(nScriptId)
	if nScriptId >= 893186 and nScriptId <= 893212 then --武道二层历练任务
		return 2
	end
	for i, findId in g_MissionTrack_AutoMissionList do --武道一层历练任务
...
function MissionTrack_AddMissionTrackInfo(nMissionIndex, nMissionTrackType, nFinished)
	...
	if (nFinished == 1 and strFinishNPC ~= "") then       --已完成的任务
		--if (strFinishNPC ~= "") then
			...
			elseif nIndex == 890638 then  --Q4打卡 寻宝乐翻天
			...
			elseif MissionTrack_CheckScriptId_CanAutoRun(nIndex) >= 1 then
				strTemp = string.format("   #W去#G%s#W找#R%s#{_INFONGAIM%d,%d,%d,%s}", strFinishSceneName, strFinishNPC, nFinishX, nFinishY, nFinishSceneID, strFinishNPC);
			else
...
function MissionTrack_JingJinMision( nMissionIndex )
	...
	if NPCname ~= "" and LPname ~= "" then
		local strTemp = string.format("#W去#G%s#W找#R%s#W", Npcscene, NPCname);
...
function MissionTrack_GetItem_JingJinMission( nIndex1,nIndex2 )
	...
	[0] ={MenPai="少林",SceneName="少林寺",NPC={[0]="#{LLRW_230309_22}",[1]="#{LLRW_230309_21}"},LP={[0]="#{XLRW_210725_481}",[1]="#{XLRW_210725_480}"},},
	[1] ={MenPai="明教",SceneName="光明殿",NPC={[0]="#{LLRW_230309_26}",[1]="#{LLRW_230309_25}"},LP={[0]="#{XLRW_210725_485}",[1]="#{XLRW_210725_484}"},},
	[2] ={MenPai="丐帮",SceneName="丐帮总舵",NPC={[0]="#{LLRW_230309_24}",[1]="#{LLRW_230309_23}"},LP={[0]="#{XLRW_210725_483}",[1]="#{XLRW_210725_482}"},},
	[3] ={MenPai="武当",SceneName="武当山",NPC={[0]="#{LLRW_230309_27}",[1]="#{LLRW_230309_28}"},LP={[0]="#{XLRW_210725_486}",[1]="#{XLRW_210725_487}"},},
	[4] ={MenPai="峨嵋",SceneName="峨嵋山",NPC={[0]="#{LLRW_230309_33}",[1]="#{LLRW_230309_34}"},LP={[0]="#{XLRW_210725_492}",[1]="#{XLRW_210725_493}"},},
	[5] ={MenPai="星宿",SceneName="星宿海",NPC={[0]="#{LLRW_230309_35}",[1]="#{LLRW_230309_36}"},LP={[0]="#{XLRW_210725_494}",[1]="#{XLRW_210725_495}"},},
	[6] ={MenPai="天龙",SceneName="天龙寺",NPC={[0]="#{LLRW_230309_29}",[1]="#{LLRW_230309_30}"},LP={[0]="#{XLRW_210725_488}",[1]="#{XLRW_210725_489}"},},
	[7] ={MenPai="天山",SceneName="天山",NPC={[0]="#{LLRW_230309_37}",[1]="#{LLRW_230309_38}"},LP={[0]="#{XLRW_210725_496}",[1]="#{XLRW_210725_497}"},},
	[8] ={MenPai="逍遥",SceneName="凌波洞",NPC={[0]="#{LLRW_230309_31}",[1]="#{LLRW_230309_32}"},LP={[0]="#{XLRW_210725_490}",[1]="#{XLRW_210725_491}"},},
	[10] ={MenPai="曼陀",SceneName="曼陀山庄",NPC={[0]="#{LLRW_230309_39}",[1]="#{LLRW_230309_40}"},LP={[0]="#{XLRW_210725_737}",[1]="#{XLRW_210725_738}"},},
...
function MissionTrack_GetItem_LiLianMission4( nIndex1,nIndex2 )
	...
	[10] ={MenPai="曼陀",NPC={[0]="#{LLRW_231010_39}",[1]="#{LLRW_231010_40}"},LP={[0]="#{XLRW_210725_737}",[1]="#{XLRW_210725_738}"},},
...
function MissionTrack_ShenFenTuPo(nMissionIndex)
	local param1 = DataPool:GetPlayerMission_Variable( nMissionIndex, 1 )--数量
--	local param2 = DataPool:GetPlayerMission_Variable( nMissionIndex, 2 )--需要道具id
	local param3 = DataPool:GetPlayerMission_Variable( nMissionIndex, 3 )--需要道具count
...
function MissionTrack_TianDeng(nMissionIndex)
	local isQiYuanFinish = DataPool:GetPlayerMission_Variable( nMissionIndex, 1 )--1号位存是否完成过祈愿
...
function MissionTrack_LongHaizi(nMissionIndex)
	local scnIndex = DataPool:GetPlayerMission_Variable(nMissionIndex,2); --任务所在场景
	local clueIndex = DataPool:GetPlayerMission_Variable(nMissionIndex,4); --任务所在场景
	local tableclues = { --洛阳
