...
local g_LootPacket_Frame_UnifiedXPosition;
local g_LootPacket_Frame_UnifiedYPosition;
...
function LootPacket_OnLoad()
	...
	--获取窗口的初始相对坐标
	g_LootPacket_Frame_UnifiedXPosition = LootPacket_Frame : GetProperty("UnifiedXPosition");
	g_LootPacket_Frame_UnifiedYPosition = LootPacket_Frame : GetProperty("UnifiedYPosition");
...
function LootPacket_Frame_On_ResetPos() 
	...
	LootPacket_Frame : SetProperty("UnifiedYPosition", g_LootPacket_Frame_UnifiedYPosition);	
end
