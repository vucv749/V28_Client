...
{
	[0]={sceneid=0,	name="L’c DﬂΩng",		posx =149, posz =145,			type = 0, npcname = "TrÏnh ThﬂΩng B·ch",},
	[1]={sceneid=3,	name="Tung SΩn",		posx =167, posz =221,			type = 0, npcname = "Khang Gia ThÒc",},
	[2]={sceneid=4,	name="Th·i H∞",		posx =180, posz =116.8,		type = 0, npcname = "TriÆu –’i Quang",},
	[3]={sceneid=1,	name="TÙ Ch‚u",		posx =177, posz =150,			type = 0, npcname = "T’ V‚n –Ïnh",},
	[4]={sceneid=5,	name="KÌnh K∞",		posx =127.7, posz =150.6,	type = 0, npcname = "La tÒ ph¯",},
	[5]={sceneid=6,	name="VÙ Lﬂ˛ng SΩn",	posx =133.3, posz =119.5,	type = 0, npcname = "PhﬂΩng T°c Th·i",},
	[6]={sceneid=2, name="–’i L˝",		posx =189, posz =135,			type = 0, npcname = "DﬂΩng Th•n Dﬂ",},
	[7]={sceneid=7,	name="Ki™m C·c",		posx =137, posz =136.2,		type = 0, npcname = "B’ch Ng˚ Th§t",},
	[8]={sceneid=8,	name="–Ùn Ho‡ng",		posx =74.3, posz =82.7,		type = 0, npcname = "Tﬂ –∞ Nh’c",},
}
