...
function PetFrame_Update_Tooltip( arg )
	PetFrame_HP:SetToolTip("Sinh l馽:"..tostring( PET_HP ) .. "/" .. tostring( PET_MAXHP).."#r".."EXP:"..tostring( PET_EXP ).."/"..tostring( PET_MAXEXP ) );
	PetFrame_Exp:SetToolTip("Sinh l馽:"..tostring( PET_HP ) .. "/" .. tostring( PET_MAXHP).."#r".."EXP:"..tostring( PET_EXP ).."/"..tostring( PET_MAXEXP ) );
