...
local g_SplitItem_Frame_UnifiedPosition;
--===============================================
-- PreLoad()
--===============================================
...
g_SplitItem_Frame_UnifiedPosition= SplitItem_Frame:GetProperty("UnifiedPosition");
...
function SplitItem_Frame_On_ResetPos()
  SplitItem_Frame:SetProperty("UnifiedPosition", g_SplitItem_Frame_UnifiedPosition);
end
