...
function Verification_OnMaxNum()
	if g_Verification_BindPhone == 0 then   --未绑定状态
...
function Verification_OnActive()
	if g_Verification_BindPhone == 0 then   --未绑定状
		return
	end
