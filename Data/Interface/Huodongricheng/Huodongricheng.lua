...
function HuoDongRiCheng_SetConsts()
	...
	HuoDongRiCheng_Text2:SetText("#cFFF263".."NÂm ".."20"..numToCh[si]..numToCh[yi]);
	...
	--local tmpstr1 = "";
	--if(si>1)then
	--	tmpstr1 = tmpstr1 .. numToCh[si+1].." Æ";
	--elseif(si>0)then
	...
	--‘Ωƒœ∞Ê±æ≤ª◊ˆ ±º‰◊™ªª
	HuoDongRiCheng_Text3:SetText("#cFFF263".."Th·ng "..tmpMon.." Ng‡y "..tmpDay);
