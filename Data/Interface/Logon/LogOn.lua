...
local TailName ={
		...
		"@sogou.com",
		"@17173.com",
		"SØ iÆn tho’i di µng Âng k˝",
		"–ﬂa v‡o m£t kh·c t‡i kho‰n hßu tØ",
		"VÙ hßu tØ t‡i kho‰n Âng k˝",
		}
...
function LogOn_LogOnWeGame_MouseEnter()
	LogOn_Info:SetText("–i¨m KÌch –Âng Nhßp trÚ chΩi");
end
...
function LogOn_Payment_MouseEnter()
	...
	LogOn_Info:SetText("Vi NhÁm –Ìch t‡i kho‰n Sung Tr∏");  --??  to  ??
end

function LogOn_RequisitionID_MouseEnter()

	LogOn_Info:SetText("Xin mµt c·i n˛ mæi H‡o");	--??  to  ??
end;

function LogOn_Author_MouseEnter()

	LogOn_Info:SetText("Xem xÈt trÚ chΩi khai ph· o‡n µi tin t—c");
end;

function LogOn_Last_MouseEnter()

	LogOn_Info:SetText("Ph‰n h∞i ph¯c v¯ KhÌ lÒa ch˜n LiÆt Bi¨u");
end;
