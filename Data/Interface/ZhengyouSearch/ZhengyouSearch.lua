...
local g_Conditions = {
	MenPai = {{"不限", 11}, {"少林", 0}, {"明教", 1}, {"丐帮", 2}, {"武当", 3}, {"峨嵋", 4}, {"星宿", 5}, {"天龙", 6}, {"天山", 7}, {"逍遥", 8}, {"曼陀山庄", 10}, {"无门派", 9}},
	Level = {"不限", "10级以下", "10到20级", "20到30级", "30到40级", "40到50级", "50到60级", "60到70级", "70到80级", "80到90级", "90到100级", "100级以上"},
	Sexy = {"不限", "男", "女"},
	Banghui = {"不限", "有帮", "无帮"},
	ADType	= {"不限", "郎才女貌", "拉帮结伙", "拜师寻徒", "义结金兰"},   -- 此处用字典不行，列表框好像不支持 {"全部", "#{ZYPT_081103_008}", "#{ZYPT_081103_009}", "#{ZYPT_081103_010}", "#{ZYPT_081103_011}",},
	HotLevel = {"不限", "0-10", "11-20", "21-30", "31-40", "41-50", "51-60", "61-70", "71-80"},
}
...
function ZhengyouSearch_BeginSearch()
	...
	--发送查找请求
	--注意：门派的全部和其它不一样，其它都是0， 而门派为10才是全部（增加新门派后11是全部）
