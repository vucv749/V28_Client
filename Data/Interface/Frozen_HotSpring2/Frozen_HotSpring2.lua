...
{
	[1] = {nInfo="太冷了",nMin=0,nMax=20,nPoint=50,nTips="#{BXPWQ_240927_106}",nImg="set:Frozen_HotSpring image:Frozen_HotSpring_GGL",nShowImg="set:Frozen_HotSpring image:Frozen_HotSpring_GGL1",}, --[nMin,nMax)
	[2] = {nInfo="正常",nMin=20,nMax=70,nPoint=120,nTips="#{BXPWQ_240927_107}",nImg="set:Frozen_HotSpring image:Frozen_HotSpring_ST",nShowImg="set:Frozen_HotSpring image:Frozen_HotSpring_ST10",},
	[3] = {nInfo="红温",nMin=70,nMax=80,nPoint=260,nTips="#{BXPWQ_240927_109}",nImg="set:Frozen_HotSpring image:Frozen_HotSpring_ZTK",nShowImg="set:Frozen_HotSpring image:Frozen_HotSpring_ZTK60",},
	[4] = {nInfo="太热了",nMin=80,nMax=100,nPoint=50,nTips="#{BXPWQ_240927_110}",nImg="set:Frozen_HotSpring image:Frozen_HotSpring_ZLR",nShowImg="set:Frozen_HotSpring image:Frozen_HotSpring_ZLR1",},
}

--奖励
local g_Frozen_HotSpring2_Award =
{
	[1] = {nInfo="一等奖",nTime=3*60,nHappy=1000,nImgok="set:Frozen_HotSpring image:RY_Hover",nImgNo="set:Frozen_HotSpring image:RY_Disabled",},
	[2] = {nInfo="二等奖",nTime=5*60,nHappy=1000,nImgok="set:Frozen_HotSpring image:QY_Hover",nImgNo="set:Frozen_HotSpring image:QY_Disabled",},
	[3] = {nInfo="三等奖",nTime=100*60,nHappy=1000,nImgok="set:Frozen_HotSpring image:SY_Hover",nImgNo="set:Frozen_HotSpring image:SY",},
}

--控件
local g_Frozen_HotSpring2_AwardList = {}	--奖励
local g_Frozen_HotSpring2_ShowImgList = {}	--温度显示
