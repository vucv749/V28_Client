		...
		for j = 1, 3, 1 do
			...
			if i ~= j then
				if setid_i ~= "" and setid_j ~= "" and setid_i == setid_j then
					PushDebugMessage("Nhçm ðã lña ch÷n ThØ môn phái, không th¬ l£p lÕi lña ch÷n.")
...
function Peak_Learn_Dec1_Attack_XDD_1_Click()
	...
	-- ÉèÖÃÊ£ÓàµãÊý°´Å¥×´Ì¬ ¸üÐÂÊ£ÓàÎäÑ§ÐÄµÃµã
	Peak_Learn_SetAcceptButtonState();
...
local nDFAttrName = {"NgoÕi công công kích","NgoÕi công phòng ngñ","Nµi công công kích","Nµi công phòng ngñ","Th¬ lñc","Lñc lßþng","Nµi Lñc","Ð¸nh lñc","Thân pháp","Công kích Võ Quyªt Ði¬m","NgoÕi công công kích","NgoÕi công phòng ngñ","Nµi công công kích","Nµi công phòng ngñ","Th¬ lñc","Lñc lßþng","Nµi Lñc","Ð¸nh lñc","Thân pháp","Thü Ngñ Võ Quyªt Ði¬m"}
