...
local g_MenPaiName = {"少林", "明教", "丐帮", "武当", "峨嵋", "星宿", "天龙", "天山", "逍遥", "无门派", "曼陀山庄"};
local g_MarryDesc = {"未婚", "已婚"};
--local g_ZhengyouMudi = { {"任意","帮派收人","寻找帮派",}, {"任意","拜师","收徒",},};

-- 此条件和征友要求里定义一致，要同时更改,记得下标加1
local g_Conditions = {
	MenPai = {"不限", "少林", "明教", "丐帮", "武当", "峨嵋", "星宿", "天龙", "天山", "逍遥", "曼陀山庄"},
	Level = {"不限", "10级以下", "10到20级", "20到30级", "30到40级", "40到50级", "50到60级", "60到70级", "70到80级", "80到90级", "90到100级", "100级以上"},
	Sexy = {"不限", "男", "女"},
...
function PlayerZhengyouPT_OnLoad()
	...
	PlayerZhengyouPT_LiuYan :Hide();      --建设和谐社会，关闭征友留言。TT:62487
...
function InitAndShowZhengyouWindow()
	FindFriendDataPool:CleanSearchRetInfo(); --清空已查询出的内容
...
function PlayerZhengyouPT_Toupiao(iSel)
	...
	if ( nSel < 0 ) then
	PushDebugMessage("请先从左边选择一个信息发布人。");
	return;
	end
...
function PlayerZhengyouPT_Jieshi_OnClick()
  ...
  local owner = FindFriendDataPool:GetDetailInfo("NAME");
	...
	DataPool:ZhengYouOpenMail( owner,"您好，我看到了您发布的" .. sType .. "征友信息，想与您结识!" );
...
function PlayerZhengyouPT_LiuYan_OnClick()
  ...
  RequestOpenZhengyouMessage(nSearchTab,nSel); --频道+选项
	return;
end
