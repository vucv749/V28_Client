...
local g_ShiDeTbl = {
											[0] = {"VÙ#r", "0#r", 0},
											[1] = {"SΩ C§p sﬂ phÛ#r", "2#r", 30},
											[2] = {"Trung C§p sﬂ phÛ#r", "3#r", 35},
											[3] = {"Cao c§p sﬂ phÛ#r", "5#r", 50},
											[4] = {"Mµt th™ hÆ Danh Sﬂ#r", "8#r", 70}
										}
...
function OtherInfo_OnShow()
	...
	OtherInfo_9_Text:SetText("Thu ∞ Æ sØ lﬂ˛ng:");
...
function SetOtherInfo_1_Tooltip()
	...
	local str =	"Sﬂ phÛ c§p bßc:"..g_ShiDeTbl[MasterLevel][1].."–Æ tÿ sØ lﬂ˛ng:"..TuDiCount.."/"..g_ShiDeTbl[MasterLevel][2].."Kh‰ ±i kinh nghiÆm:"..TrueExp
