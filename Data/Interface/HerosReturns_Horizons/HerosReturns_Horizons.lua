...
local g_HerosReturns_Horizons_JiangHu={
	[2] = {
		...
		[2] = { Name="#{HLYH_220613_43}", Level="#{HLYH_220613_44}", Image="set:Huodong_14 image:Huodong_14_4", Desc="#{HLYH_220613_5}", 
			...
			Task={ 
				[1]={ Name="#{HLYH_220613_11}", id=2, Bonus=5, xPos=134, zPos=81, sceneId=1, NpcName="Vân Lan Châu" },
				[2]={ Name="#{HLYH_220613_12}", id=3, Bonus=8, xPos=134, zPos=81, sceneId=1, NpcName="Vân Lan Châu" },
				} 
		},
		--½£×ÝÉ½ºÓ
		[3] = { Name="#{HLYH_220613_45}", Level="#{HLYH_220613_46}", Image="set:Huodong_13 image:Huodong_13_9", Desc="#{HLYH_220613_6}", 
			...
			Task={ 
				[1]={ Name="#{HLYH_220613_13}", id=4, Bonus=5, xPos=166, zPos=108, sceneId=0, NpcName="Chu Thßþng" },
				[2]={ Name="#{HLYH_220613_14}", id=5, Bonus=8, xPos=166, zPos=108, sceneId=0, NpcName="Chu Thßþng" },
				} 
		},
	},
	[3] = {
		...
		[4] = { Name="#{HLYH_220613_47}", Level="#{HLYH_220613_48}", Image="set:WuhunTupu1 image:WuhunTupu1_4", Desc="#{HLYH_220613_7}", 
			...
			Task={ 
				[1]={ Name="#{HLYH_220613_15}", id=6, Bonus=3, xPos=136, zPos=180, sceneId=2, NpcName="Võ TrÕch" },
				[2]={ Name="#{HLYH_220613_16}", id=7, Bonus=3, xPos=136, zPos=180, sceneId=2, NpcName="Võ TrÕch" },
				} 
		},
		--Ë®ÔÂÉ½×¯
...
--Ò³ÃæÇÐ»» 1¡¢¹éÀ´ÀñÀ¡ 2¡¢½­ºþ¸æÁî 3¡¢ÈÙ¹é¸ó 4¡¢½­ºþ¼ûÎÅ
