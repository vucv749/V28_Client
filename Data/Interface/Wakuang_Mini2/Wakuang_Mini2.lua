...
local g_Wakuang_Mini2_SceneId;

function Wakuang_Mini2_PreLoad()
...
function Wakuang_Mini2_OnLoad()	

end

function Wakuang_Mini2_OnEvent(event)
	...
	elseif event == "PLAYER_LEAVE_WORLD" then
		this:Hide()
	elseif event == "UI_COMMAND" and tonumber(arg0) == 20230510 then
	...
	elseif event == "UI_COMMAND" and tonumber(arg0) == 202305101 then
		local opType =  Get_XParam_INT( 0 )
...
function Wakuang_Mini2_Open()
		PushEvent("WAKUANG_SWITCH2", 2)
end
