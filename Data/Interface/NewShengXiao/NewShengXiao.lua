...
local g_MissionPos={
[1]={scn=2,x=160,z=157,npcname="赵天师"},--任务1
[2]={scn=0,x=158,z=105,npcname="龙小威"},--任务2
[3]={scn=0,x=158,z=105,npcname="龙小威"},--任务4
[4]={scn=0,x=158,z=105,npcname="龙小威"},--任务6
[5]={scn=0,x=161,z=105,npcname="蛇小瑞"},--礼包1-3
}
...
function NewShengXiao_Update()
	...
	if curDay < g_NewShengXiao_BoxDay[1] then
		...
		NewShengXiao_5_FuZi_Disable:Show()--尚未到达开启时间，敬请期待。
	...
	elseif curDay >= g_NewShengXiao_BoxDay[1] and curDay <= g_NewShengXiao_BoxDay[3] then
		...
		if mdday == curDay then
			--已经领过福贴了
			NewShengXiao_5_FuZi_GoToBtn:Hide()--您可点击此处前往蛇小瑞处，领取福贴，赠福万侠！
			NewShengXiao_5_FuZi_Disable:Hide()--尚未到达开启时间，敬请期待。
			...
			NewShengXiao_5_ChestBtn_Open:Hide()
			NewShengXiao_5_ChestBtn:Hide()
			NewShengXiao_5_FuZi_GoToBtn:Show()--您可点击此处前往蛇小瑞处，领取福贴，赠福万侠！
			NewShengXiao_5_FuZi_Disable:Hide()--尚未到达开启时间，敬请期待。
			NewShengXiao_5_BK_Light:Show()
