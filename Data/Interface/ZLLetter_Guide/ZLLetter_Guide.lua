...
local g_ZLLetter_Guide_Info = {
	[0]={name="#{YXDHYD_20210207_81}", posx=160, posz=157, sceneid=2, npc="Tri®u Thiên Sß"},
	[1]={name="#{YXDHYD_20210207_82}", posx=160, posz=157, sceneid=2, npc="Tri®u Thiên Sß"},
	[2]={name="#{YXDHYD_20210207_83}", posx=129, posz=107, sceneid=1, npc="Th¦m DÕ Vû"},
	[3]={name="#{YXDHYD_20210207_84}", posx=129, posz=107, sceneid=1, npc="Th¦m DÕ Vû"},
	[4]={name="#{YXDHYD_20210207_85}", posx=129, posz=107, sceneid=1, npc="Th¦m DÕ Vû"},
	[5]={name="#{YXDHYD_20210207_86}", posx=160, posz=157, sceneid=2, npc="Tri®u Thiên Sß"},
	[6]={name="#{YXDHYD_20210207_87}", posx=129, posz=107, sceneid=1, npc="Th¦m DÕ Vû"},
	[7]={name="#{YXDHYD_20210207_88}", posx=160, posz=157, sceneid=2, npc="Tri®u Thiên Sß"},
	[8]={name="#{YXDHYD_20210207_89}", posx=137, posz=180, sceneid=2, npc="Võ TrÕch"},
	[9]={name="#{YXDHYD_20210207_90}", posx=137, posz=180, sceneid=2, npc="Võ TrÕch"},
	[10]={name="#{YXDHYD_20210207_91}", posx=160, posz=157, sceneid=2, npc="Tri®u Thiên Sß"},
	[11]={name="#{YXDHYD_20210207_92}", posx=126, posz=96, sceneid=0, npc="Thái Kinh"},
	[12]={name="#{YXDHYD_20210207_93}", posx=126, posz=96, sceneid=0, npc="Thái Kinh"},
	[13]={name="#{YXDHYD_20210207_94}", posx=193, posz=144, sceneid=1, npc="Chüng Sß ÐÕo"},
	[14]={name="#{YXDHYD_20210207_95}", posx=193, posz=144, sceneid=1, npc="Chüng Sß ÐÕo"},
	[15]={name="#{YXDHYD_20210207_96}", posx=193, posz=144, sceneid=1, npc="Chüng Sß ÐÕo"},
	[16]={name="#{YXDHYD_20210207_97}", posx=193, posz=144, sceneid=1, npc="Chüng Sß ÐÕo"},
}
