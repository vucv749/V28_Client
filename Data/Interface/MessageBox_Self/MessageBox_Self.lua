...
--		MessageBox_Self_Text:SetText( "Chú ý! #Viên ðá quý ho£c phù kh¡c bÕn mu¯n kh¡c là v§t ph¦m ðã khóa (bind), sau khi kh¡c, ðá quý cûng s¨ b¸ khóa theo bÕn. Nªu xác nh§n mu¯n tiªp tøc kh¡c, vui lòng nh¤n nút Kh¡c thêm l¥n næa." );
