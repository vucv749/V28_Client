...
local FrameInfoList = {
	...
	QUICKUP_PET_CONFIRM					= 6,			--珍兽快速提升二次确认
	PET_HUANTONT_CONFIRM				= 7,			--宠物还童元宝确认 add:lby2015
	PET_LINGXING_CONFIRM 				= 8,	--宠物提灵元宝确认 add:lby2015 
	CONVENIENT_BUY_CONFIRM				= 9, 	--消费优化，二次确认
	BILLINGAWARD_CONFIRM = 10,		--Billing领取奖励二次提示
	MATERIALCOMPOUND_CONFIRM = 11,		--寒玉合成二次提示
	WHWG_GRADEUP_CONFIRM = 12,			--武魂外观进阶
	DRESSPAINT_BINDITEM_CONFIRM = 13,	--时装染色道具绑定二次确认
	XIARIDAKA_CONFIRM = 14, --夏日打卡
	NEW_DAKONG_CONFIRM						= 19,			--新打孔
	NEW_XIANGQIAN_CONFIRM					= 20,			--新镶嵌
	NEW_ZHAICHU_CONFIRM						= 21,			--新摘除
	DARK_SKILL_RECOIN_CONFIRM = 38, 	-- 暗器技能重洗二次确认
	SUPER_ATTR_RECOIN_CONFIRM =40,		-- 神器重洗二次确认
	WUHUN_SKILL_RECOIN_CONFIRM = 44, 	-- 重洗武魂技能的二次确认
	DOUBLE_SECKILL_CONFIRM	= 48,
	YBMARKET_CONFIRM_MULTIBUY	= 49,			--元宝交易市场批量购买确认
	SECKILL_GIVEUP_CONFIRM = 79, --扫荡丢弃确认
	DRESS_TRANSFER_BIND_CONFIRM = 90,
	DRESS_TRANSFER_BUYITEM_CONFIRM = 91,
	CONFIRM_IMMIGRATION  = 94,				 -- 移民
	CONFIRM_CANCEL_IMMIGRATION  = 95,				 -- 取消移民
	PETSOUL_EXCHANGE_CONFIRM = 96,
	PETSOUL_XISHUXING_CONFIRM = 97,
	PETSOUL_FUSION_CONFIRMBIND = 98, --兽魂凝魂 绑定确认
	PETSOUL_BLOODLEVELUP_CONFIRM = 99, --兽魂育魂 确认
	...
	APPLY_SNAKING_NUM_SECOND_CONFIRM = 153, --申请摇号二次确认
	LILIANMISSION23_CONFIRM = 154, --武道二层历练任务 任务3 重新挑战确认
	DWLEVELUP_BINDCONFIRM = 155,
	DW_CONSUMESURE_EQUIPDWLEVELUP = 156,
	PRIZE_WAITING = 158,
	QINGQIU_BUYCONFIRM = 159, 
	WEEKLYSHOP_BUYCONFIRM = 163,
	XUYUANCHI_ITEM = 164,--2022周年庆 许愿池 筑建道具
	GONGCANJIAWEI_CONFIRM = 165,--元旦应景
	...
	MARRY_PLANE_NOTICE  = 183,				 -- 婚礼方案通知窗口
	PETTAYIN_CONFIRM = 184,			--珍兽拓印二次确认
	
	PETTAYIN_YBbuy_CONFIRM		= 186,			--珍兽拓印 元宝购买二次确认
	
	QIXITOPLIST_CONFIRM		= 187,			--七夕花榜二次确认
	PETSOUL_RANSE_CONFIRM = 188,
	PETSOUL_RANSE_ZIDONG_CONFIRM = 189,
	SECKILL_TESE = 190,
	LILIANMISSION2_CONFIRM = 191, --武道二层历练任务 任务2 花费金币确认
	QIONGQI_SWALLOW_CONFIRM = 192,--穷奇吞噬
	QIONGQI_RESTORE_CONFIRM = 193,--穷奇还原
	
	QINGRENJIETOPLIST_CONFIRM		= 194,			--情人节花榜二次确认
	YULONGZAITIAN_CONFIRM			=195,			--春节织绣新衣-御龙在天自选礼包
	
	QRJTOPLIST_EXCHANGE_CONFIRM		= 196,			--情人节花榜兑换二次确认
	
	REPUTATIONSHOP_BUY_CONFIRM		= 197,			--势力商店购买二次确认
	
	EQUIP_REFRESH_EQUIP_CHANGE_CONFIRM		= 198,
	EQUIP_REFRESH_CLOSE_CONFIRM		= 199,
	EQUIP_REFRESH_BIND_CONFIRM		= 200,
	CONFIRM_CANCEL_ODER_IMMIGRATION = 224, -- 取消定制移民
	SHENFENYURE_RESELECT = 225,
	
	ZIDIAN_PICKONE_CONFIRM = 226, -- 飞凰礼包二选一
	DUANWUDAKA_CONFIRM = 227,

	CONFIRM_DWJINJIE = 228,
	CONFIRM_DWJINJIESHENGJI = 229,
	CONFIRM_DWJINJIEHUITUI = 230,
	CONFIRM_ORNAMENTS_CONFIRM = 231,	--头背挂
	DAHUA_DAIBI_CONFIRM = 232,
	CONFIRM_QIXIPVE_LEAVE = 233,
	DAHUA_DAIBI_SHOP_CONFIRM = 234,

	QIXIRANK_EXCHANGE_CONFIRM = 235, --2015七夕情人节兑换确认
...
function WuhunQuest_OnEvent(event)
	...
	if event == "PLAYER_LEAVE_WORLD" then	
		if g_FrameInfo == FrameInfoList.LILIANMISSION23_CONFIRM --武道二层历练任务 任务3 重新挑战确认
			or g_FrameInfo == FrameInfoList.LILIANMISSION2_CONFIRM then--武道二层历练任务 任务2 花费金币确认
	...
	elseif ( event == "UI_COMMAND" and tonumber(arg0) == 2015101414 ) then  --add:lby2015还童
		local strMsg = Get_XParam_STR(0);
		local notify = Get_XParam_INT(0);
		local nType = Get_XParam_INT(1);
		local nCurrencyUnit = Get_XParam_INT(2);
	...
	elseif ( event == "UI_COMMAND" and tonumber(arg0) == 2015101514 ) then  --add:lby2015提灵
		local strMsg = Get_XParam_STR(0);
		local notify = Get_XParam_INT(0);
		local nType = Get_XParam_INT(1);
		local nCurrencyUnit = Get_XParam_INT(2);
	...
	elseif ( event == "QUICKUP_PET_CONFIRM") then
		 local nType = tonumber(arg0); 			--1是悟性，2是灵性，3是融合度，4是成长率
		 ...
		 local nPrice = tonumber(arg2);			--元宝数
		 local nUplimit = tonumber(arg3);		--成长率上限
	...
	elseif ( event == "UI_COMMAND" and tonumber(arg0) == 807012 ) then
		...
		WuhunQuest_InfoWindow:SetText( msg );	-- 设置内容
		...
		this:Show();
	elseif (tonumber(arg0) == 99850602 ) then--兽魂染色
		WuhunQuest_Clear_Var()
		g_FrameVar[1] = Get_XParam_INT(0)
		g_FrameVar[2] = Get_XParam_INT(1)
		g_FrameVar[3] = Get_XParam_INT(2)
	...
	elseif ( event == "PETSOUL_RANSE_CONFIRM") then--ranse
		...
		WuhunQuest_InfoWindow:SetText( "#{SHRS_230621_141}" );	-- 设置内容
		g_FrameInfo = FrameInfoList.PETSOUL_RANSE_CONFIRM ;
		WuhunQuest_Button1:Show()
		WuhunQuest_Button1:SetText("#{INTERFACE_XML_557}");  --确定
		WuhunQuest_Button2:Show()
	...
	elseif ( event == "QIXIRANK_EXCHANGE_CONFIRM" ) then
		...
		WuhunQuest_Button2:SetText("#{INTERFACE_XML_542}");  --取消
		WuhunQuestUpdateRect();
		DataPool:SetCanUseHotKey(0)															-- 恢复窗口大小到初始大小
		this:Show();
	elseif ( event == "PETSOUL_RANSE_ZIDONG_CONFIRM") then--ranse zidong
		...
		if g_FrameVar[1] == 1 then
			...
			WuhunQuest_InfoWindow:SetText( str );	-- 设置内容
		end
		...
		DataPool:SetCanUseHotKey(0)
		this:Show();
	elseif ( event == "UI_COMMAND" and tonumber(arg0) == 99852202 ) then --穷奇吞噬 
		WuhunQuest_Clear_Var()
		...
		g_FrameVar[3]  = Get_XParam_INT(2)
		g_FrameVar[4]  = Get_XParam_INT(3)
		WuhunQuest_InfoWindow:SetText( "#{QQJG_20230815_21}" );	-- 设置内容
		g_FrameInfo = FrameInfoList.QIONGQI_SWALLOW_CONFIRM ;
		WuhunQuest_Button1:Show()
		WuhunQuest_Button1:SetText("#{QQJG_20230815_22}");  --确定
		WuhunQuest_Button2:Show()
		WuhunQuest_Button2:SetText("#{QQJG_20230815_23}");  --取消
		WuhunQuestUpdateRect();
		DataPool:SetCanUseHotKey(0)
		this:Show();
	elseif ( event == "UI_COMMAND" and tonumber(arg0) == 99852204 ) then --穷奇还原 
		WuhunQuest_Clear_Var()
		
		g_FrameVar[1]  = Get_XParam_INT(0)
		g_FrameVar[2]  = Get_XParam_INT(1)

		WuhunQuest_InfoWindow:SetText( "#{QQJG_20230815_27}" );	-- 设置内容
	...
	elseif ( event == "UI_COMMAND" and tonumber(arg0) == 80012707 ) then
		...
		g_FrameVar[3]= Get_XParam_INT(2);
		g_FrameVar[4]= Get_XParam_INT(3);
		WuhunQuest_InfoWindow:SetText( "#{SHCX_20211229_48}" );	-- 设置内容
		g_FrameInfo = FrameInfoList.PETSOUL_XISHUXING_CONFIRMPERFECT ;
		WuhunQuest_Button1:Show()
		WuhunQuest_Button1:SetText("#{SHCX_20211229_05}");  --确定
		WuhunQuest_Button2:Show()
		WuhunQuest_Button2:SetText("#{SHCX_20211229_06}");  --取消
		WuhunQuestUpdateRect();
		DataPool:SetCanUseHotKey(0)
		this:Show();
	elseif ( event == "UI_COMMAND" and tonumber(arg0) == 99869801 ) then--2024Q1身份预热任务
		WuhunQuest_Clear_Var()
		g_FrameVar[1] =Get_XParam_INT(0);
		WuhunQuest_InfoWindow:SetText( "#{SFYR_240104_204}" );	-- 设置内容
		g_FrameInfo = FrameInfoList.SHENFENYURE_RESELECT ;
		WuhunQuest_Button1:Show()
		WuhunQuest_Button1:SetText("#{SFYR_240104_205}");  --确定
		WuhunQuest_Button2:Show()
		WuhunQuest_Button2:SetText("#{SFYR_240104_206}");  --取消
		WuhunQuestUpdateRect();
		DataPool:SetCanUseHotKey(0)
		this:Show();
	elseif ( event == "UI_COMMAND" and tonumber(arg0) == 99859602 ) then--飞凰礼包二选一
		WuhunQuest_Clear_Var()
		g_FrameVar[1] = Get_XParam_INT(0);
		WuhunQuest_InfoWindow:SetText( "#{WYCJ_20240320_35}" );	-- 设置内容
		g_FrameInfo = FrameInfoList.ZIDIAN_PICKONE_CONFIRM ;
		WuhunQuest_Button1:Show()
		WuhunQuest_Button1:SetText("#{WYCJ_20240320_36}");  --确定
		WuhunQuest_Button2:Show()
		WuhunQuest_Button2:SetText("#{WYCJ_20240320_37}");  --取消
		WuhunQuestUpdateRect();
		DataPool:SetCanUseHotKey(0)
		this:Show();
	elseif ( event == "UI_COMMAND" and tonumber(arg0) == 99881901 ) then
		...
		WuhunQuest_Button1:Show()
		WuhunQuest_Button1:SetText("#{HZLH_20240415_111}");  --确定
		WuhunQuest_Button2:Show()
		WuhunQuest_Button2:SetText("#{HZLH_20240415_112}");  --取消
		WuhunQuestUpdateRect();
		DataPool:SetCanUseHotKey(0)
		this:Show();
	elseif ( event == "UI_COMMAND" and tonumber(arg0) == 80012709 ) then
		...
		g_FrameVar[3]= Get_XParam_INT(2);
		g_FrameVar[4]= Get_XParam_INT(3);
		WuhunQuest_InfoWindow:SetText( "#{SHCX_20211229_51}" );	-- 设置内容
	...
	elseif ( event == "UI_COMMAND" and tonumber(arg0) == 80602105 ) then
		...
		if planeLevel == 3 then
			WuhunQuest_InfoWindow:SetText( "#{JHYH_230330_333}" );	-- 设置内容
		else
			WuhunQuest_InfoWindow:SetText( "#{JHYH_230330_142}" );	-- 设置内容
		end

		g_FrameInfo = FrameInfoList.MARRY_PLANE_NOTICE ;
		WuhunQuest_Button1:Show()
		WuhunQuest_Button1:SetText("#{JHYH_230330_332}");  --确定
		WuhunQuest_Button2:Show()
		WuhunQuest_Button2:SetText("#{INTERFACE_XML_542}");  --取消
		WuhunQuestUpdateRect();
		DataPool:SetCanUseHotKey(0)
	...
	elseif ( event == "UI_COMMAND" and tonumber(arg0) == 998478002 ) then
		...
		WuhunQuest_Button1:Show()
		WuhunQuest_Button1:SetText("#{ZSHF_20230705_35}");  --确定
		WuhunQuest_Button2:Show()
		WuhunQuest_Button2:SetText("#{ZSHF_20230705_36}");  --取消
		WuhunQuestUpdateRect();
		DataPool:SetCanUseHotKey(0)
		this:Show();
	...
	elseif event == "UI_COMMAND" and tonumber(arg0) == 89030513 then --DWJINJIEHUITUI
		WuhunQuest_Clear_Var()
			...
			g_FrameVar[5] = Get_XParam_INT(4) --价值
			--local itemID = PlayerPackage:GetItemTableIndex(g_FrameVar[3])
...
function WuhunQuest_Bn1Click()
	...
	elseif (g_FrameInfo == FrameInfoList.CONFIRM_IMMIGRATION) then
		...
		Set_XSCRIPT_ParamCount(3)
		Send_XSCRIPT()
	elseif(g_FrameInfo == FrameInfoList.PETSOUL_RANSE_CONFIRM) then--兽魂染色
		Clear_XSCRIPT()
	...
	elseif(g_FrameInfo == FrameInfoList.PETSOUL_RANSE_ZIDONG_CONFIRM) then--兽魂染色 zidong
		PushEvent("PETSOUL_RANSE_ZIDONG_CONFIRM_BACK")

	elseif (g_FrameInfo == FrameInfoList.QIONGQI_SWALLOW_CONFIRM) then--穷奇吞噬
	...
	elseif (g_FrameInfo == FrameInfoList.QIONGQI_RESTORE_CONFIRM) then--穷奇还原
	...
	elseif g_FrameInfo == FrameInfoList.MARRY_PLANE_NOTICE then
		AutoRuntoTargetExWithName(177, 94, 0, "喜来乐")
...
function WuhunQuest_WeeklyShopConfirm()
	...
	WuhunQuest_Button1:Show()
	WuhunQuest_Button1:SetText("#{ZCSD_220802_08}");  --确定
	WuhunQuest_Button2:Show()
	WuhunQuest_Button2:SetText("#{ZCSD_220802_09}");  --取消
	WuhunQuestUpdateRect();
	DataPool:SetCanUseHotKey(0)
	this:Show();
...
function WuhunQuest_QingQiuShopConfirm()
	...
	WuhunQuest_Button1:Show()
	WuhunQuest_Button1:SetText("#{QQSD_220801_7}");  --确定
	WuhunQuest_Button2:Show()
	WuhunQuest_Button2:SetText("#{QQSD_220801_8}");  --取消
	WuhunQuestUpdateRect();
	DataPool:SetCanUseHotKey(0)
	this:Show();
...
function WuhunQuest_Open_Window_SellItemConfirmQ8(nItemPos,equipQual,opType)
	...
	if equipStar >= 7 and nNeedQueRen ~= 0 then
		...
		g_FrameVar[1] = tonumber(nItemPos)
		WuhunQuest_InfoWindow:SetText(ScriptGlobal_Format(strMsg,equipStar));	-- 设置内容
		g_FrameInfo = FrameInfoList.SELL_ITEM_CONFIRM;
		WuhunQuest_Button1:Show()
		WuhunQuest_Button1:SetText("#{YZZBMD_220627_05}");  --确定
		WuhunQuest_Button2:Show()
		WuhunQuest_Button2:SetText("#{YZZBMD_220627_06}");  --取消
		WuhunQuest_CheckClient:Show()
		WuhunQuest_CheckBtn:Show()
		WuhunQuest_CheckText:Show()
...
function WuhunQuest_Open_Window_HuantongConfirm(strMsg, nType, nCurrencyUnit, nPrice, nItemIndex, nSerialNum, nUniqueID )--add:lby2015还童
	WuhunQuest_Clear_Var()
...
function WuhunQuest_Open_Window_LingxingConfirm(strMsg, nType, nCurrencyUnit, nPrice, nItemIndex, nSerialNum, nUniqueID )--add:lby2015提灵
	WuhunQuest_Clear_Var()
...
function WuhunQuest_BillingAward_Confirm( strText, nIndex )
	...
	WuhunQuestUpdateRect();
	WuhunQuest_Button1:Show()
	WuhunQuest_Button1:SetText("#{LJSJ_160308_10}");  --确定
	WuhunQuest_Button2:Show()
	WuhunQuest_Button2:SetText("#{LJSJ_160308_11}");  --取消
...
function Apply_Snaking_Num_Second_Confirm()
	...
	WuhunQuest_Button1:Show()
	WuhunQuest_Button1:SetText("#{RCYH_180522_54}");  --确定
	WuhunQuest_Button2:Show()
	WuhunQuest_Button2:SetText("#{RCYH_180522_55}");  --取消
	WuhunQuestUpdateRect();
	DataPool:SetCanUseHotKey(0)
	this:Show();
end
...
function WuhunQuest_DressPaintBind_confirm(nType,nDressPos,nParam)
	...
	WuhunQuest_Button1:Show()
	WuhunQuest_Button1:SetText("#{SZRSYH_210315_04}");  --确定
	WuhunQuest_Button2:Show()
	WuhunQuest_Button2:SetText("#{SZRSYH_210315_05}");  --取消
	WuhunQuestUpdateRect()
...
function WuhunQuest_LiLianMission23_Confirm()
	...
	WuhunQuest_Button1:Show()
	WuhunQuest_Button1:SetText("#{XZDZ_220428_124}")  --重新挑战
	WuhunQuest_Button2:Show()
	WuhunQuest_Button2:SetText("#{XZDZ_220428_125}")  --离开副本
	WuhunQuestUpdateRect()
	DataPool:SetCanUseHotKey(0)
	this:Show()
end
...
function WuhunQuest_ConsumeSure_EquipDWLevelup(nBagPos, nLevelUpTo, requireJCS, UserjcsCnt, UserBYBCnt, UserYBCnt)
	...
	if UserBYBCnt>0 and UserYBCnt==0 then
		--本次雕纹升级需要消耗A个金蚕丝，您背包中现有B个未锁定的金蚕丝。点击确定按钮后，将扣除背包内全部未锁定的金蚕丝和C绑定元宝（用来补足剩余的金蚕丝）。点击取消时，将放弃本次升级。
	...
	elseif UserBYBCnt==0 and UserYBCnt>0 then
		--本次雕纹升级共需A个金蚕丝，您背包中有B个未锁定的金蚕丝。点击确定按钮后，将扣除背包内全部未锁定的金蚕丝和C元宝（等同于XX个金蚕丝）完成升级。点击取消时，将放弃本次升级操作。
...
function WuhunQuest_YuLongZaiTian_Gift_Confirm()
	...
	WuhunQuest_InfoWindow:SetText(strMsgForComfirm);  -- 设置内容	
	WuhunQuest_Button1:Show()
	WuhunQuest_Button1:SetText("#{ZYJX_211124_47}");  --确定
	WuhunQuest_Button2:Show()
	WuhunQuest_Button2:SetText("#{ZYJX_211124_48}");  --取消
	WuhunQuestUpdateRect();
	DataPool:SetCanUseHotKey(0)
	this:Show();
end
...
function WuhunQuest_Ornaments_Confirm(optype,bagIndex,tableIndex)
	...
	WuhunQuest_Button1:Show()
	WuhunQuest_Button1:SetText("#{BGTS_220125_26}")  --确定
	WuhunQuest_Button2:Show()
	WuhunQuest_Button2:SetText("#{BGTS_220125_27}")  --取消
	WuhunQuestUpdateRect()
