...
local g_Mission1SubInfo = {
    [1] = {path = {cliectScene=2,x=191,z=131,npc="天仙妹妹"},gotoText = "#{FQZC_230331_45}"},
    [2] = {path = {cliectScene=260,x=65,z=164,npc="沧澜"},gotoText = "#{FQZC_230331_45}"},
    [3] = {path = {cliectScene=592,x=225,z=149,npc="花照水"},gotoText = "#{FQZC_230331_45}"},
    [4] = {path = {cliectScene=4,x=158,z=190,npc="江思璇"},gotoText = "#{FQZC_230331_45}"},
    [5] = {path = {cliectScene=164,x=271,z=175,npc="晁端礼"},gotoText = "#{FQZC_230331_45}"},
}

local g_MissionInfo = {
    [1] = {title="#{FQZC_230331_37}"},
    [2] = {title="#{FQZC_230331_38}",path = {cliectScene=164,x=79,z=45,npc="凌振"}},
    [3] = {title="#{FQZC_230331_39}",path = {cliectScene=1,x=170,z=134,npc="苏陶"}},
    [4] = {title="#{FQZC_230331_40}",path = {cliectScene=1,x=97,z=204,npc="苏轼"}},
    [5] = {title="#{FQZC_230331_41}",path = {cliectScene=0,x=40,z=60,npc="花仙"}},
}
