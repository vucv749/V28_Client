...
function CampaignTrack_OnLoad()
	...
	g_CampaignTrack_Frame_UnifiedSize = CampaignTrack_Frame:GetProperty("UnifiedSize");
	g_CampaignTrack_Frame_UnifiedXPosition = CampaignTrack_Frame:GetProperty("UnifiedXPosition");
	g_CampaignTrack_Frame_UnifiedYPosition = CampaignTrack_Frame:GetProperty("UnifiedYPosition");

	g_CampaignTrack__Frame_AbsolutePosition = CampaignTrack__Frame:GetProperty("AbsolutePosition");
	g_CampaignTrack__Frame_AbsoluteSize = CampaignTrack__Frame:GetProperty("AbsoluteSize");

	g_CampaignTrack_Function_Frame_AbsolutePosition = CampaignTrack_Function_Frame:GetProperty("AbsolutePosition");

	g_CampaignTrack_DragTitle_AbsolutePosition = CampaignTrack_DragTitle:GetProperty("AbsolutePosition");
	g_CampaignTrack_Close_AbsolutePosition = CampaignTrack_Close:GetProperty("AbsolutePosition");
	g_CampaignTrack__CheckBox_Frame_AbsolutePosition = CampaignTrack__CheckBox_Frame:GetProperty("AbsolutePosition");
	g_CampaignTrack_Lock_AbsolutePosition = CampaignTrack_Lock:GetProperty("AbsolutePosition");
	g_CampaignTrack_UnLock_AbsolutePosition = CampaignTrack_UnLock:GetProperty("AbsolutePosition");
end
...
function CampaignTrack_OnEvent(event)
	...
	elseif (event == "ADJEST_UI_POS") then
		local nCurX = CampaignTrack_Frame:GetProperty("AbsoluteXPosition")
		local nCurY = CampaignTrack_Frame:GetProperty("AbsoluteYPosition")
		local nCurWidht	= CampaignTrack_Frame:GetProperty("AbsoluteWidth")
		local nCurHeigh	= CampaignTrack_Frame:GetProperty("AbsoluteHeight")
...
function CampaignTrack_Reset_Func()
	CampaignTrack_Frame:SetProperty("UnifiedSize", g_CampaignTrack_Frame_UnifiedSize);
	CampaignTrack_Frame:SetProperty("UnifiedXPosition", g_CampaignTrack_Frame_UnifiedXPosition);
	CampaignTrack_Frame:SetProperty("UnifiedYPosition", g_CampaignTrack_Frame_UnifiedYPosition);

	CampaignTrack__Frame:SetProperty("AbsolutePosition", g_CampaignTrack__Frame_AbsolutePosition);
	CampaignTrack__Frame:SetProperty("AbsoluteSize", g_CampaignTrack__Frame_AbsoluteSize);

	CampaignTrack_Function_Frame:SetProperty("AbsolutePosition", g_CampaignTrack_Function_Frame_AbsolutePosition);

	CampaignTrack_DragTitle:SetProperty("AbsolutePosition", g_CampaignTrack_DragTitle_AbsolutePosition);
	CampaignTrack_Close:SetProperty("AbsolutePosition", g_CampaignTrack_Close_AbsolutePosition);
	CampaignTrack__CheckBox_Frame:SetProperty("AbsolutePosition", g_CampaignTrack__CheckBox_Frame_AbsolutePosition);
	CampaignTrack_Lock:SetProperty("AbsolutePosition", g_CampaignTrack_Lock_AbsolutePosition);
	CampaignTrack_UnLock:SetProperty("AbsolutePosition", g_CampaignTrack_UnLock_AbsolutePosition);
end
