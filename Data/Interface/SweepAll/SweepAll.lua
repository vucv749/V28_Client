...
function SweepAll_OnPrivilegeButtonClick()
	...
	--≈–∂œMD÷– «∑Ò“—æ≠º«¬º¡À¡Ω∏ˆª•≥‚±Íº« begin ∆‰ µ†‚¿Ô÷±Ω”≈–∂œ «∑ÒΩ¯––¡À¡Ω¥ŒÃÿ»®…®µ¥æÕ––
	local dayCount = DataPool:LuaFnGetMD(g_SweepAll_SeckillTequanDayCount)
	--PushDebugMessage(tostring(dayCount))--≤‚ ‘
	...
	--PushDebugMessage(tostring(PrivilegedExclusiveFlag)..","..tostring(firstFlag)..","..tostring(secondFlag))--≤‚ ‘
...
function SweepAll_OnSweepButtonClick()
	...
	PushDebugMessage("BÍn trong sai l•m")
