...
function SongliaoWarSingle_Battle_Fresh()	
	...
	local chiyouzhanqi = ScriptGlobal_Format("#{XSLDZ_180521_249}", "宋军")
	if myCamp == 157 then
		chiyouzhanqi = ScriptGlobal_Format("#{XSLDZ_180521_249}", "辽军")
	end
