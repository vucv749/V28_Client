...
{
	--Å®ÐÔÏà¹ØÎ»ÖÃ  {fHeight = 0.85, fDistance = 12, fPitch=0.2, fXOffset= 0 }, 
	...
	--ÄÐÐÔÏà¹ØÎ»ÖÃ  {fHeight = 0.85, fDistance = 12, fPitch=0.28, fXOffset= 0 }, 
...
function GemEffectPreview_OnEvent(event) 
	...
	elseif (event == "UI_COMMAND" and tonumber(arg0) == 20120406) then
		-- ²»ÄÜºÍ±äÐÔ½çÃæÍ¬Ê±´æÔÚ  »¹ÓÐ¼ÓÒ»¶ÑÆäËûµÄ»¥³â
		if (this:IsVisible()) then 
			this:Hide()
		end
