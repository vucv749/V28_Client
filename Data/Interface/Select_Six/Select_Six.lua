...
local g_Select_Six_CurBagPos = -1 --礼包在玩家背包中的位置
local g_Select_Six_CurSelIndex = 0 --当前选中几个item
local g_Select_Six_CurLiBaoItemIndex = 0 --使用的礼包id
...
local g_Select_Six_ItemId ={
	[1] = {
		title = "#{SHYBJ_20210805_29}", --固灵仙露自选礼盒·6阶
		gift_id = 38003677,
		item_id = {
			38003475,
			38003476,
