-- XiaRi_YanMen ÐÇ»ðÉúÑãÃÅÖ÷½çÃæ 2022-5-9 lishilong
...
-- {
-- 	[5] = {strShowMsg = "#{XHSYM_20220426_145}", strInfoMsg = "#{XHSYM_20220426_157}"	}, --²ß»®ÁÙÊ±ÆðÐË£¬ÏëÈÃÈÎÎñ5½×¶Î½çÃæ¸ù¾ÝÈ ÆÚÏÔÊ¾²»Í¬ÄÚÈÝ 7.12-7.13 ÏÔÊ¾ â¸ö
-- }

-- local g_tableAutoRunInfo	= 
-- {
-- 	[2076] = {nClientSceneID = 587, nPosX = 160,		nPosZ = 331, 	strNPCName = "ÄþÍñÒ¹", },
-- 	[2077] = {nClientSceneID = 588, nPosX = 164,		nPosZ = 332, 	strNPCName = "ºÎ°²³Ç", },
-- 	[2078] = {nClientSceneID = 588, nPosX = 164,		nPosZ = 332, 	strNPCName = "ºÎ°²³Ç", },
-- }
...
-- local g_goBtnText = 
-- {
-- 	[0] = "#{XHSYM_20220426_47}" ,  --Ç°Íù
-- 	[1] = "#{XHSYM_20220426_144}"  --Áì½±
-- }
