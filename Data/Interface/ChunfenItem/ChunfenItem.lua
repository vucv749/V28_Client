...
function ChunfenItem_OnLoad()
	...
	g_ItemID =
	{
		...
		[2] = {itemid = 38002533, count = 3, name = "淬魂液"},
		[3] = {itemid = 30503132, count = 2, name = "百淬神玉"},
		[4] = {itemid = 38002524, count = 1, name = "鹿蜀魂玉"},
		[5] = {itemid = 30501361, count = 1, name = "功力丹"},
		[6] = {itemid = 10124625, count = 1, name = "青阳山色（7天）"},
