...
function ChatInfo_Update()
	...
	ChatInfo_Name:SetText( "T阯: "..DataPool:GetFriend( "chat", "NAME"  ) );
	--AxTrace( 0,0,"char LEVEL" );
	ChatInfo_Level:SetText( "C: "..tostring( DataPool:GetFriend( "chat", "LEVEL" ) ) );
	--AxTrace( 0,0,"char MENPAI_TEXT" );
	ChatInfo_MenPai:SetText( "Ph醝: "..DataPool:GetFriend( "chat", "MENPAI_TEXT" ) );
	...
	ChatInfo_Explain:SetText( "T.Tr課g: "..DataPool:GetFriend( "chat", "MOOD" ) );
	--AxTrace( 0,0,"char TITLE" );
	ChatInfo_Agname:SetText( "D.Hi畊: "..DataPool:GetFriend( "chat", "TITLE" ) );
end
