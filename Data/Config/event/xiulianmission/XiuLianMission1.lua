...
{
	[1] = { sname = "#{XLRW_210725_263}", npcname = "#{XLRW_210725_267}", name = "Bùi Tuyên", sceneid = 0, },
	[2] = { sname = "#{XLRW_210725_263}", npcname = "#{XLRW_210725_268}", name = "Châu Bang NgÕn", sceneid = 0, },
	[3] = { sname = "#{XLRW_210725_263}", npcname = "#{XLRW_210725_269}", name = "Vß½ng Tích Tân", sceneid = 0, },
	[4] = { sname = "#{XLRW_210725_263}", npcname = "#{XLRW_210725_270}", name = "Hoài Bính", sceneid = 0, },
	[5] = { sname = "#{XLRW_210725_263}", npcname = "#{XLRW_210725_271}", name = "Chß½ng Ðôn", sceneid = 0, },
	[6] = { sname = "#{XLRW_210725_263}", npcname = "#{XLRW_210725_272}", name = "Lã Hu® Khanh", sceneid = 0, },
	[7] = { sname = "#{XLRW_210725_264}", npcname = "#{XLRW_210725_273}", name = "Khô Vinh ÐÕi Sß", sceneid = 2, },
	[8] = { sname = "#{XLRW_210725_264}", npcname = "#{XLRW_210725_274}", name = "H°ng ÐÕi Quý", sceneid = 2, },
	...
	[16] = { sname = "#{XLRW_210725_265}", npcname = "#{XLRW_210725_282}", name = "Ð£ng Bách Xuyên", sceneid = 1, },
	[17] = { sname = "#{XLRW_210725_265}", npcname = "#{XLRW_210725_283}", name = "Chu Ðan Th¥n", sceneid = 1, },
	[18] = { sname = "#{XLRW_210725_265}", npcname = "#{XLRW_210725_284}", name = "Hoa Kiªm Vû", sceneid = 1, },
}
