...
x999432_g_Custom							= {{ id = "Tra xét manh m¯i", num = 6},{ id = "Chäi vu¯t sþi vu án", num = 1}} 
-- x999432_g_ClueNum = {{id = "tra xét manh m¯i", num = 6}} --Ð® 1V¸ lßþng biªn ð±i
-- x999432_g_IsIntergration = {{id = "chäi vu¯t sþi vu án", num = 1}} -- Ð® 2V¸ lßþng biªn ð±i
