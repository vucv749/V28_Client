...
x808080_g_IsMissionOkFail	= 0		--??????0?

--nhi®m vø vån bän miêu tä
x808080_g_MissionName			= "Nhi®m vø Rùa-Thö thi chÕy"
--nhi®m vø miêu tä
...
--m²i l¥n Quân Th¯ thi chÕy hoÕt ðµng c¥n Tá Ca Ðích thành th¸ t±ng s¯
x808080_g_MaxRound	= 3
--kh¯ng chª k¸ch bän g¯c
x808080_g_ControlScript		= 001066

-- nhi®m vø hoàn thành tình hu¯ng, nµi dung ðµng thái näy sinh cái m¾i, phân bi®t chiªm døng nhi®m vø tham s¯ Ðích Ð® 1, 2, 3, 4V¸
x808080_g_Custom	= { {id="Ðã cùng LÕc Dß½ng Tri®u Minh Thành ð¯i thoÕi",num=1}, {id="Ðã cùng Tô Châu Løc Sî Tranh ð¯i thoÕi",num=1}, {id="Ðã cùng ÐÕi Lý Vß½ng Nhßþc Vû ð¯i thoÕi",num=1}, {id="Ðã châm toàn bµ ðèn Kh±ng Minh",num=24} }
