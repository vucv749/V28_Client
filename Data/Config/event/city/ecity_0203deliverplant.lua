...
--nhi®m vø lßþng biªn ð±i ð® nh¤t v¸ dùng ð¬ t°n træ TuÏ C½ nh§n ðßþc Ðích k¸ch bän g¯c Hào

--nhi®m vø vån bän miêu tä
x600010_g_MissionName = "Nhi®m vø phát tri¬n"
x600010_g_MissionInfo = "Hôm nay ta nghî Yêu %s Li­u, ði giúp Ngã Träo ðªn ðây ði!"			--????
x600010_g_MissionTarget = "Tß¾ng%iðßa cho%n. #r#{BHRW_091224_1}"			--????
...
x600010_g_MissionComplete = "Làm ðßþc không t°i, r¤t t¯t r¤t t¯t."					--????npc????
